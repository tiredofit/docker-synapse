...
### Prebuilt Images
Builds of the image are available on [Docker Hub](https://hub.docker.com/r/tiredofit/synapse) and is the recommended method of installation.

```bash
docker pull tiredofit/synapse:(imagetag)
```
...
| `HTTP_LISTEN_COMPRESS`         |             | `TRUE`              |
| `HTTP_LISTEN_ENABLE_TLS`       |             | `FALSE`             |
| `HTTP_LISTEN_PORT`             |             | `8008`              |
| `HTTP_LISTEN_X_FORWARDED`      |             | `TRUE`              |
| `LOG_BUFFER`                   |             | `10`                |
| `LOG_FILE`                     |             | `homeserver.log`    |
| `LOG_INTERVAL_FLUSH_FORCE`     |             | `5`                 |
| `LOG_LEVEL`                    |             | `INFO`              |
| `LOG_LEVEL_FLUSH`              |             | `30`                |
| `LOG_LEVEL_LDAP`               |             | `${LOG_LEVEL}`      |
| `LOG_LEVEL_LDAP_AUTH_PROVIDER` |             | `${LOG_LEVEL}`      |
| `LOG_LEVEL_SQL`                |             | `INFO`              |
